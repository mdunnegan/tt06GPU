...
__global__ void make_randomNums( double* randArray, int num_cells, int num_changing_vars, int sf, int total_s2_times, int simulations) {
	curandState local;
